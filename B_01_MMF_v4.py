...
# Credit car surcharge (currently 5%)
...
while tickets_sold < MAX_TICKETS:
    # ask user for their name (and check it's not a blank)
    print()
    name = not_blank("Name: ")
    ...
    # ask users for their age and check it's between 12 and 120
    age = int_check("Age: ")
    ...
    # add name, ticket cost and surcharge to frame
...
# profit number so that the winning ticket is excluded)
...
#winner announcement
lucky_winner_string = f"The winner is {winner}. Their ticket worth is ${ticket_won:.2f} is free!"
...
adjusted_sales_heading = make_statement("Adjusted Sales & Profit",
                                        "-")
adjusted_explanation = (f"We have given away a ticket worth ${tickets_sold:.2f} which means \nour "
